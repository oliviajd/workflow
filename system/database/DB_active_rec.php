...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 * @return	object
	 */
	public function where($key, $value = NULL, $escape = TRUE, $delim = '')
	{
		//var_dump($delim);
		return $this->_where($key, $value, 'AND ', $escape, $delim);
	}
	 ...
	 * @return	object
	 */
	public function or_where($key, $value = NULL, $escape = TRUE, $delim = '')
	{
		//var_dump($delim);
		return $this->_where($key, $value, 'OR ', $escape, $delim);
	}
	 ...
	 * @return	object
	 */
	protected function _where($key, $value = NULL, $type = 'AND ', $escape = NULL, $delim = '')
	{
		// var_dump($delim);
		if ( ! is_array($key))
		{
