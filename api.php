...
function _rare_shutdown_catch_error() {
    ...
    if ($_error && in_array($_error['type'], array(1, 4, 16, 64, 256, 4096, E_ALL))) {
        ...
        file_put_contents(realpath(__DIR__) . '/application/api/logs/error.' . date('Y-m-d') . '.log', $str, FILE_APPEND);
    }
}
...
require_once APPPATH . 'libraries/obj_base.php';
require_once APPPATH . 'libraries/jx.php';
require_once APPPATH . 'models/ObjInterface.php';

// define('MEMCACHE_HOST','localhost');
// define('MEMCACHE_PORT',11211);

define('APP_CSS_JS_PATH','/data/app/');
define('API_URL', 'http://a.api.com/api.php');
define('API_ADMIN_URL', 'http://a.api_admin.com/api_admin.php');
