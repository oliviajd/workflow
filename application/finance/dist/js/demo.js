...
var FINANCE_ACCOUNT_SUB = {};
FINANCE_ACCOUNT_SUB.add = function(option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/finance/account/sub/add',
        data: $.extend({},option.account,{token:option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
...
FINANCE_ACCOUNT_SUB.update = function(option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/finance/account/sub/update',
        data: $.extend({},option.account,{token:option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
...
FINANCE_ACCOUNT_SUB.get = function(option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/finance/account/sub/get/',
        data: $.extend({finance_account_sub_id: option.finance_account_sub_id},{token:option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
        }
...
FINANCE_ACCOUNT_SUB.delete = function(option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/finance/account/sub/delete/',
        data: $.extend({finance_account_sub_id: option.finance_account_sub_id},{token:option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
...
FINANCE_ACCOUNT_SUB.lists = function(option) {
    var callback = option.callback || function () {};
    $.ajax({
...
} else if (window.location.host == 'dev_finance.com') {
    var INIT = {
        'API_HOST': 'http://api_lsk.com/api.php',
        'SOURCE_HOST': 'http://api_lsk.com/api.php'
    };
