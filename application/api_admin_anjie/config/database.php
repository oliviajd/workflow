...
// local : 本地
//$db['localhost']['hostname'] = '192.168.0.198';
$db['localhost']['hostname'] = 'localhost';
$db['localhost']['username'] = 'root';

// $db['localhost']['database'] = 'anjie';
// $db['localhost']['password'] = 'ifcar99.com';
// $db['localhost']['port'] = 3306;
$db['localhost']['database'] = 'dev_anjie';
$db['localhost']['password'] = 'root';
$db['localhost']['port'] = 3307;
