...
<div class="container grid-s165m0 layout">
	...
	<div class="col-main bg_line">
		<div class="main-wrap">
			<h1 class="title"><?php echo  $_REQUEST['method_name'];?>　</h1>
			<div class="sub-wrap" data-spm="1998342952">
				<h3 class="head-title">简要描述</h3>
				<div class="api-list">
					 <?php echo $api_cate_detail['desc']?>
				</div>
			</div>
			<div class="sub-wrap" data-spm="1998342952">
				<h3 class="head-title">属性</h3>
				<div class="api-list">
					<table style="width: 100%" id="_list">
						...
						<?php foreach($api_obj_detail_list as $k=>$v){
						    $link_cate_name = is_base_type($v['cate_name']) ? $v['cate_name'] : '<a
									href="/api_admin/obj_show?cid=' . $_REQUEST['cid'] . '&item_id=' . $v['obj_id'] . '&cate_name=' . $_REQUEST['cate_name'] . '&method_name=' . $v['cate_name'] . '&apiid=' . $_REQUEST['apiid'] . '">' . $v['cate_name'] . '</a>';
