...
$(function(){
    $('#form1').submit(function(){
        ...
        if(_flag == true)
        {
            location.href = '/api_admin/obj_detail?cate_type='+cate_type+'&item_id='+item_id+'&field_id='+field_id;
            _flag = false;
        }
...
<div class="container grid-s165m0 layout">
	...
	<div class="sub_menu" style="padding: 10px;">
		<span><a
			href="/api_admin/obj_detail?cate_type=<?php echo $_REQUEST['cate_type']?>&item_id=<?php echo $_REQUEST['item_id']?>"
			class="btn">分类列表</a></span> <span><a
			href="/api_admin/obj_detail?cate_type=<?php echo $_REQUEST['cate_type']?>"
