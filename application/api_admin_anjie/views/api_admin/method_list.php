...
function funcAjaxAddMethod(page_field, d)
{
    ...
    $.ajax({
        type : 'GET',
        url : '/api_admin/ajax?m=method_update',
        async : false,
        data : d,
        dataType : 'json',
...
function func_method_delete(method_id)
{
    if(confirm('你确定要删除吗 ?'))
    {
        $.ajax({
            type : 'GET',
            url : '/api_admin/ajax?m=method_delete',
            async : false,
...
function func_input_select(_this, cate_type, method_id)
{
    ...
    $.ajax({
        type : 'GET',
        url : '/api_admin/ajax?m=input_list',
        async : false,
...
// console.log(cate_type, typeof cate_type);
        ...
        $.ajax({
            type : 'GET',
            url : '/api_admin/ajax?m=input_update',
            async : false,
            data : d,
            dataType : 'json',
            success : function(data){
...
<div class="container grid-s165m0 layout">
	...
	<div class="sub_menu" style="padding: 10px;">
		<span><a
			href="/api_admin/method_list?cate_type=<?php echo $_REQUEST['cate_type']?>&item_id=<?php echo $_REQUEST['item_id'] ?>"
...
function func_method_show(method_id)
{
        $.ajax({
            type : 'GET',
            url : '/api_admin/ajax?m=method_show',
            async : false,
            data : {method_id:method_id},
            dataType : 'json',
            success : function(data){
