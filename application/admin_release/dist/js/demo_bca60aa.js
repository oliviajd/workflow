...
BANNER.delete = function (option){
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/banner/delete',
        data: $.extend({'id':option.id},{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r);
...
var CASH_CONTROL={};
CASH_CONTROL.update = function (option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/user/update_cash_control',
        data: {cash_control:option.cash_control,q:option.q},
        dataType: 'json',
        success: function (r) {
            callback(r);
        }
...
var MESSAGE = {};
MESSAGE.add = function (option) {
    var message = {
        
    }
    $.extend(message, option.message);
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/add',
        data: $.extend(message,{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r);
        }
...
MESSAGE.update = function (option) {
    ...
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/update',
        data: $.extend({message_id:option.message_id},message,{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r);
        }
...
MESSAGE.get = function (option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/get',
        data: $.extend({'message_id':option.message_id},{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r);
        }
...
MESSAGE.lists = function (option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/lists',
        data: $.extend({'activity_id':option.activity_id},{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r);
...
MESSAGE.delete = function (option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/delete',
        data: $.extend({'pid':option.pid},{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
...
MESSAGE.send = function (option) {
    var callback = option.callback || function () {};
    $.ajax({
        url: API_HOST + '/message/send',
        data: $.extend({'user_id':option.user_id,'message_id':option.message_id,'remark':option.remark},{'token':option.token}),
        dataType: 'json',
        success: function (r) {
            callback(r,option);
        }
