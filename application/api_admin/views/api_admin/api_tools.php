			...
			<?php }?>
				...
				<tr>
					<td align="center" colspan="2">将鼠标移至说明上，查看参数介绍；<font color="red">*</font>
						表示必填；<a
						href="/api_admin.php/api_admin/show?cid=<?php echo $api_method_detail['cid']?>&cate_name=<?php echo $api_cate_detail['cate_name'];?>&apiid=<?php echo $api_method_detail['method_id']?>"
...
function getAPI(){
	...
	var cid = $("#select_cate").val();
	   ...
	   $.ajax({
         type : 'GET',
         url  : '/api_admin.php/api_admin/ajax?m=get_api',
         async : false,
         data : {cid:cid},
         dataType : 'json',
...
function getMethod(){
	var mid =   $('#select_api').val();
	 $.ajax({
         type : 'GET',
         url  : '/api_admin.php/api_admin/ajax?m=get_method',
         async : false,
         data : {mid:mid},
         dataType : 'json',
         success : function(data){
