 ...
 * @author win7
 */
class wangdaizhijia extends CI_Controller {

    const KEY = 'ifcar99@wangdaizhijia';
    ...
    public function login() {
        ...
        //后台添加访问权限
        $this->api->in['from'] = 'wangdaizhijia';
        $this->api->in['device'] = 'wangdaizhijia';
    ...
    public function borrow_lists() {
        ...
        $condition['success_start_time'] = strtotime($this->api->in['date']);
        $condition['success_end_time'] = $condition['success_start_time'] + 3600 * 24 - 1;
        ...
        $result = array(
            ...
            'totalCount' => $count,
            'totalAmount' => $this->m_borrow->sum_account($condition),
            'currentPage' => $page,
            'borrowList' => $rows,
        );
        echo json_encode($result);
