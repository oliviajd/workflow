            ...
            <ul class="APIgory">
                <li>
                    <div class="APIgory-title">
                        <a href = "/api_admin/manage?cid=<?php echo $_REQUEST['cid']?>&cate_name=<?php echo $_REQUEST['cate_name'];?>" title="API说明文档">返回&nbsp;<span class = "APIgory-sub-title"> <?php echo $_REQUEST['cate_name'];?></span></a>
                    </div>
                </li>
